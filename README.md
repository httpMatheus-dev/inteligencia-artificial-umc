...
- `Exercicios_Python_MatheusGabrielAlves_6B_Noturno.ipynb` — notebook com os
...
- `Iris_SVM_MatheusGabrielAlves_6B_Noturno.ipynb` — classificação das espécies do dataset
  Iris utilizando Support Vector Machine (SVM). Inclui análise exploratória, preparação
...
- `vendas.xlsx` — arquivo lido via `pd.read_excel()` no exercício 2 (Pandas) da Lista 2.
